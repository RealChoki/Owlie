...
instructions = (
    ...
    " anregen, ohne die akademische Integrität zu gefährden. Falls ein Studierender nach 'Test Arrays' oder einem anderen"
    " Thema fragt, nutze die bereits vorbereiteten Fragen und führe ihn Schritt für Schritt durch das Thema jeweils eine"
    " Frage auf einmal. Falls er Schwierigkeiten hat, leite ihn sanft zur Antwort und unterstütze sein Verständnis durch"
    " kurze Erklärungen oder Beispiele mit anschließenden Übungen. Verwende bei Bedarf Pseudocode im folgenden Format:"
    " START"
